...
func (server *Server) CreateUser(ctx context.Context, req *pb.CreateUserRequest) (*pb.CreateUserResponse, error) {
	...
	// if it fails to send the task, the whole transaction will be rolled back And the user won’t exist in the database,
	// Which means, the client can safely retry the request without any issues.
